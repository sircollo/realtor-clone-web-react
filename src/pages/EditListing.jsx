...
import { addDoc, doc, collection, getDoc, updateDoc, serverTimestamp, getDocs } from "firebase/firestore"
...
export default function CreateListing() {
    ...
    async function onSubmit(e){
        ...
        const docRef = doc(db, "listings", params.listingid)
        await updateDoc(docRef, formDataCopy || null)
        setLoading(false);
  ...
  return (
    <main className='max-w-md px-2 mx-auto'>
       ...
       <form onSubmit={onSubmit}>
        ...
        <button type='submit' className='w-full mb-6 px-7 py-3 bg-blue-600 text-white uppercase font-medium text-sm rounded shadow-md hover:bg-blue-700 hover:shadow-lg focus:bg-blue-800 focus:shadow-lg active:bg-blue-900 active:shadow-lg transition duration-150 ease-in-out'>Update Listing</button>
       </form> 
    </main>
  )
}
